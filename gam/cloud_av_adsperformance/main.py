# -*- coding: utf-8 -*-
"""
ActiveView → BigQuery - DADOS DE PERFORMANCE GAM COM UTM_CONTENT
─────────────────────────────────────────────────────────────────────────
Coleta metricas diarias por site GAM via ActiveView API (/from-gam):
- date, network_id, site_name, key, value, impressions, clicks, ctr, revenue, ecpm, match_rate

Schedule: 13:00 UTC (10:00 BRT) — dados de ontem com margem de seguranca
...
TABLE_ID = "data-v1-423414.test.cloud_av_adsperformance_historical"
