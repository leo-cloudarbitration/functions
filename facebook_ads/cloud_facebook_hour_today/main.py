...
def load_groups_config():
    ...
    try:
        ...
        # Sobe um nível (de cloud_facebook_hour_today para facebook_ads)
...
TABLE_ID = "data-v1-423414.test.cloud_facebook_hour"
...
async def main():
    ...
    logger.info("Iniciando execução local do script (DADOS HOURLY DE HOJE) com ASYNC...")
