...
ADICIONA os dados no BigQuery (WRITE_APPEND) - acumula histórico completo
"""
...
def execute_notebook(event, context):
    ...
    upload_execution_metadata(results, execution_time, "cloud_facebook_historical_utc_complete")
