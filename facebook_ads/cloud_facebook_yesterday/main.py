# -*- coding: utf-8 -*-
"""
Facebook → BigQuery (Cloud Function) - DADOS DE ONTEM
─────────────────────────────────────────────────────
Coleta:
...
BIGQUERY_TABLE_ID = "data-v1-423414.test.cloud_facebook_yesterday_ca"
...
def execute_notebook(event, context):
    ...
    upload_execution_metadata(results, execution_time, "cloud_facebook_yesterday_complete")
...
if __name__ == "__main__":
    start_time = time.time()
    logger.info("Iniciando execução local do script (DADOS DE ONTEM)...")
    ...
    logger.info("=" * 80)
    logger.info("📊 RESUMO FINAL DA EXECUÇÃO (DADOS DE ONTEM)")
    logger.info("=" * 80)
