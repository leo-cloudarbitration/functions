# Facebook Ads Yesterday - GitHub Actions

Este projeto coleta dados de performance de campanhas do Facebook de **ONTEM** e os envia para o BigQuery usando GitHub Actions.

## 🎯 Objetivo

Coletar métricas diárias de campanhas do Facebook de **ONTEM** e armazenar no BigQuery com sobrescrita completa (WRITE_TRUNCATE).

## 📅 Período de Coleta

- **Data coletada:** ONTEM (date_preset: "yesterday")
- **Exemplo:** Se hoje é 07/01/2026, coleta dados de 06/01/2026
- **Atualização:** 5 vezes por dia nos horários: 00:58, 01:58, 03:58, 10:58, 18:58 (horário BRT)
...
**BigQuery:**
- **Tabela:** `data-v1-423414.test.cloud_facebook_yesterday_ca`
...
```
facebook_ads/cloud_facebook_yesterday/
...
- **Agendado**: 5 vezes por dia no minuto 58 (em UTC):
  - 00:58 BRT (03:58 UTC)
  - 01:58 BRT (04:58 UTC)
  - 03:58 BRT (06:58 UTC)
  - 10:58 BRT (13:58 UTC)
...
3. Execute:
```bash
cd facebook_ads/cloud_facebook_yesterday
...
📊 Linhas finais: 2000
☁️ Enviando 2000 registros para data-v1-423414.test.cloud_facebook_yesterday_ca...
✅ Adicionados 2000 registros para data-v1-423414.test.cloud_facebook_yesterday_ca
```
...
4. **Frequência:** Executa 5 vezes por dia para manter os dados atualizados
...
```sql
CREATE TABLE `data-v1-423414.test.cloud_facebook_yesterday_ca` (
  account_name STRING,
  account_id STRING,
  campaign_id STRING,
...
2. O workflow está configurado em:
   - `.github/workflows/cloud_facebook_yesterday.yml`
